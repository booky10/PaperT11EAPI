...
public class SetMaxHealth extends CommandExecutor {
    ...
    public SetMaxHealth() {
        super(Main.main, "maxhealth", "/maxhealth <player> <health>",
            ...
            if (target != null) {
                ...
                try {
                    ...
                    if (args[1].equalsIgnoreCase("reset")
                        ...
                        player.sendMessage(Main.PREFIX + "<health> must be a number!");
                        return;
                    }
                }
                AttributeHelper.setMaxHealth(target, health);
                player.sendMessage(Main.PREFIX + "§aThe max health has been modified!");
            } else
