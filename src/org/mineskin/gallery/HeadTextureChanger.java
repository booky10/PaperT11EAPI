...
public class HeadTextureChanger {
    ...
    static final Class<?> NBTTagCompound = nmsClassResolver.resolveSilent("NBTTagCompound");
    static final Class<?> NBTBase = nmsClassResolver.resolveSilent("NBTBase");
    static final Class<?> GameProfileSerializer = nmsClassResolver.resolveSilent("GameProfileSerializer");
    static final Class<?> CraftMetaSkull = obcClassResolver.resolveSilent("inventory.CraftMetaSkull");

    static final Class<?> GameProfile = classResolver.resolveSilent("net.minecraft.util.com.mojang.authlib" +
    ...
    public static SkullMeta applyTextureToMeta(SkullMeta meta, Object profile) throws Exception {
        ...
        NBTTagCompoundMethodResolver.resolve(new ResolverQuery("set", String.class, NBTBase)).invoke(baseNBTTag,
                "SkullOwner", ownerNBTTag);

        SkullMeta newMeta =
				(SkullMeta) CraftMetaSkullConstructorResolver.resolve(new Class[]{NBTTagCompound}).newInstance(baseNBTTag);
